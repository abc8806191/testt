...
cl = LINE()
cl.log("EJZinXWGFpy8lzdJ4sle.+7d/ziTcN1MPJm/bq5mMZG.uM2h3v/7VDfX2OPnBeXmpfg23D8Y10WV7b8J+VNsu4E= : " + str(cl.authToken))

ki = LINE()
ki.log(" EJHkwfCA32fHIL1IMAb7.xdHdtMUSRNCzu9ZAa5/MbW.uWH4v+FFtCOvqe5P5fbHNNasj4w4bYRCTt3bZBxmNFc=: " + str(ki.authToken))
